    ...
    <div class="mall">
        ...
        <div class="mall-main">
            <a-card :bordered="false" class="filter-card">
                ...
                <div class="filter-row">
                    ...
                    >
                        ...
                        <a-radio-button value="sales">销量优先</a-radio-button>
            ...
            <a-spin :spinning="loading">
                <a-empty v-if="!list.length && !loading" description="没有找到商品" />
...
import { pageQueryProduct } from "@/api/product";
...
const SORT_MAP = {
    ...
    sales: { orderBy: "sales", order: "desc" },
...
const fetchList = async () => {
    ...
    try {
        ...
        const res = await pageQueryProduct({
