<template>
  <div class="stack-16">
    ...
    <div class="chart-grid">
      <el-card><div ref="logChart" style="height: 320px"></div></el-card>
      <el-card><div ref="roleChart" style="height: 320px"></div></el-card>
    </div>
  </div>
</template>
...
import { User, Bell, Document, TrendCharts } from '@element-plus/icons-vue'
